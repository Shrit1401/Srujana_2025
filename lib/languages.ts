...
export const translations = {
  en: {
    ...
    weeklyTeachingPlan: "Weekly Teaching Plan",
  ...
  hi: {
    ...
    generatingPlan: "योजना बना रहे हैं...",
    generateNewPlan: "नई योजना बनाएं",
    weeklyTeachingPlan: "साप्ताहिक शिक्षण योजना",
    generatedSuccessfully: "सफलतापूर्वक बनाया गया",
  ...
  mr: {
    ...
    generatingPlan: "योजना तयार करत आहे...",
    generateNewPlan: "नवीन योजना तयार करा",
    weeklyTeachingPlan: "साप्ताहिक शिक्षण योजना",
    generatedSuccessfully: "यशस्वीरित्या तयार केले",
  ...
  ta: {
    ...
    generateNewPlan: "புதிய திட்டத்தை உருவாக்கவும்",
    weeklyTeachingPlan: "வாராந்திர கற்பித்தல் திட்டம்",
    generatedSuccessfully: "வெற்றிகரமாக உருவாக்கப்பட்டது",
    exportPDF: "PDF ஐ ஏற்றுமதி செய்யவும்",
  ...
  te: {
    ...
    generatingPlan: "ప్లాన్‌ను సృష్టిస్తోంది...",
    generateNewPlan: "కొత్త ప్లాన్‌ను సృష్టించండి",
    weeklyTeachingPlan: "వారపు బోధనా ప్రణాళిక",
    generatedSuccessfully: "విజయవంతంగా సృష్టించబడింది",
