...
export async function generateWorksheet(formData: FormData, questions: number) {
  try {
      ...
      messages: [
        {
          ...
          content: [
            {
              type: "text",
              text: "Create comprehensive study notes based on this image for kids who are in primary year. Format the response as proper markdown with the following structure:\n\n# Study Notes: [Topic]\n\n## Key Concepts\n- Important concept 1 with explanation\n- Important concept 2 with explanation\n- Important concept 3 with explanation\n\n## Important Points\n1. **Point 1**: Detailed explanation\n2. **Point 2**: Detailed explanation\n3. **Point 3**: Detailed explanation\n\n## Examples\n- Example 1 with explanation\n- Example 2 with explanation\n\n## Summary\nBrief summary of the main topics covered\n\n## Additional Notes\nAny extra information, tips, or related concepts\n\nGenerate comprehensive, well-structured notes that would help primary year students understand and study the content shown in the image. Use clear headings, bullet points, and numbered lists. Make the notes educational, easy to follow, and suitable for young children.",
            },
            {
              type: "image_url",
              image_url: {
